 ...
 * <p>
 **/
public class FlutterFragmentActivity extends AppCompatActivity implements View.OnClickListener, SplashScreenProvider {
    ...
    public void onClick(View v) {
        ...
        if (mTab1 == v) {
            ...
            mFragment = new FlutterFragment.NewEngineFragmentBuilder().url("flutter://PersonPage").build();

        } else if (mTab2 == v) {
            mTab2.setBackgroundColor(Color.YELLOW);
            mFragment = new FlutterFragment.NewEngineFragmentBuilder().url("flutter://MessagePage").build();
        } else if (mTab3 == v) {
